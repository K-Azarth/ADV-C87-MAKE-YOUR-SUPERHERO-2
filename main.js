...
function MyKeydown(e) {
    ...
    if (Key == "70") {
        Block_add("Ultimate_Superhero_Face.png");
        console.log("f is pressed")
    }
    if (Key == "66") {
        Block_add("Ultimate_Superhero_Body.png");
        console.log("b is pressed")
    }
    if (Key == "76") {
        Block_add("Ultimate_Superhero_Legs.png");
        console.log("l is pressed")
    }
    if (Key == "66") {
        Block_add("Ultimate_Superhero_Righthand.png");
